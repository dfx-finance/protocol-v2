...
contract AssimilatorV2 is IAssimilator {
        ...
        returns (int128 amount_, int128 balance_)
    {
        ...
        balance_ = ((_balance * _rate) / 10**oracleDecimals).divu(10**tokenDecimals); // ABDKMATH64x64 form NOT numeraire

        amount_ = ((_tokenAmount * _rate) / 10**oracleDecimals).divu(10**tokenDecimals);
    }
